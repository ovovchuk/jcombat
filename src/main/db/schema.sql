...
(
  ...
  CONSTRAINT answers_questions_id_fc FOREIGN KEY (question_id) REFERENCES questions (id),
...
(
  ...
  user_health2 TINYINT UNSIGNED                    NOT NULL,
  question_id  CHAR(36)                            NOT NULL,
  ...
  INDEX session_stats_session_id_index (session_id),
  ...
  CONSTRAINT session_stats_sessions_id_fc FOREIGN KEY (session_id) REFERENCES sessions (id)
)
  DEFAULT CHARSET = utf8;
